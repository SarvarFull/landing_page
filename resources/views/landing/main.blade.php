        ...
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    @if (!$user)
                        <a href="{{ route('register.page') }}" type="submit" class="btn btn-outline-success">Sign
                            in
                    ...
                    @else
                        {
                        <a href="{{ route('sign.out') }}" type="button" class="btn btn-outline-danger">Sign Out
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                    ...
                    <a href="{{ route('admin.register.page') }}" type="submit" class="btn btn-outline-info"><svg
        ...
        <div class="col-md-5 offset-md-3 mb-3">
            <form>
                ...
                <div class="d-flex flex-column flex-sm-row w-100 gap-2">
                    ...
                    <input id="newsletter1" name="newsletter" type="email" class="form-control"
                        placeholder="Email address" required>
                    <button class="btn btn-primary" name="ok" type="submit">Subscribe</button>
                </div>
            </form>
        </div>
        <hr class="featurette-divider">
        <p class="float-end mt-3"><a href="#">Back to top</a></p>
        <p>&copy; 2017–2024 Company, Inc. &middot; <a href="#">Privacy</a> &middot; <a href="#">Terms</a>
        </p>
    </footer>


    <!-- Bootstrap 5.3 JavaScript Here -->
